...
public:
    // IRequest methods
    HRESULT STDMETHODCALLTYPE Initialize(_In_ IWDFDevice *pWdfDevice, _In_ PCWSTR pszTargetPath);
    HRESULT STDMETHODCALLTYPE CreateAndSendWrite(_In_reads_(inBufferSize) BYTE *pInBuffer, _In_ SIZE_T inBufferSize);
